                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: CustomTextFormField(
                              ...
                              obscureText: BlocProvider.of<AuthCubit>(
                                context,
                              ).isObscure,
                          ...
                          SizedBox(height: screenSize.height * 0.02),
                          Text('Phone Number', style: Styles.textStyle15),
                          SizedBox(
                            width: double.infinity,
                            height: 59,
                            child: CustomTextFormField(
                              ...
                              onChanged: (value) {
                                userModel.phoneNumber = value.toString();
                              },
                            ),
                          ),
                          Text('Address', style: Styles.textStyle15),
                          SizedBox(
                            width: double.infinity,
                            height: 59,
                            child: CustomTextFormField(
                              ...
                              onChanged: (value) {
                                userModel.address = value.toString();
                              },
                            ),
                          ),
                        ],
